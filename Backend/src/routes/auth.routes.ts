...
/**
   ...
   * @access Public
*/
authRouter.post("/register", authLimiter, validate(registerzodSchema),authController.registerUser);
...
/**
   ...
   * @access Public
*/
authRouter.post("/login", authLimiter, validate(loginzodSchema),authController.loginUser);
